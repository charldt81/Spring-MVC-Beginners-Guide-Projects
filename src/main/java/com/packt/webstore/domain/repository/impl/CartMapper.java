...
// this 'CartMapper.java' class was added from Chapter_9
...
// We created a class called 'CartMapper' which we're going to use to map the database records to the CartItem and Cart domain object in the repository classes.
