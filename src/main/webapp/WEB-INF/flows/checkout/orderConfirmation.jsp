...
<%-- Added the 'orderConfirmation.jsp' file from Chapter_10 --%>
	...
	<div class="container">
		<div class="row">
			<form:form modelAttribute="order" class="form-horizontal">
				...
				<div class="well col-xs-10 col-sm-10 col-md-6 colxs-offset-1 col-sm-offset-1 col-md-offset-3">
					...
					<div class="row">
						...
						<div class="col-xs-6 col-sm-6 col-md-6 text-right">
							<p>
								<em>Shipping DateDate: <fmt:formatDate type="date" value="${order.shippingDetail.shippingDate}" /></em>
							</p>
						</div>
					</div>
							...
							<tbody>
								<c:forEach var="cartItem" items="${order.cart.cartItems}">
									<tr>
										...
										<td class="col-md-1 textcenter">$${cartItem.product.unitPrice}</td>
										<td class="col-md-1 textcenter">$${cartItem.totalPrice}
										</td>
									</tr>
								...
								<tr>
									<td></td>
									<td></td>
									<td class="text-right"><h4><strong>Grand Total: </strong></h4></td>
									<td class="text-center textdanger"><h4><strong>$${order.cart.grandTotal}</strong></h4></td>
								</tr>
							</tbody>
						</table>
						
						<button id="back" class="btn btn-default" name="_eventId_backToCollectShippingDetail">back</button>
						<button type="submit" class="btn btnsuccess" name="_eventId_orderConfirmed">Confirm<span class="glyphicon glyphicon-chevron-right"></span></button>
