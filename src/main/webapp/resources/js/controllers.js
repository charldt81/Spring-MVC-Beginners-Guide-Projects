...
cartApp.controller('cartCtrl', function($scope, $http) {
	$scope.refreshCart = function(cartId) {
		$http.get('/CodeCollegeSpringToolSuit_1_webstore/rest/cart/' + $scope.cartId).success(function(data) {
			$scope.cart = data;
		});
	};
	...
	$scope.clearCart = function() {
		$http.delete('/CodeCollegeSpringToolSuit_1_webstore/rest/cart/' + $scope.cartId).success(function(data) {
	...
	$scope.addToCart = function(productId) {
		$http.put('/CodeCollegeSpringToolSuit_1_webstore/rest/cart/add/' + productId).success(function(data) {
	...
	$scope.removeFromCart = function(productId) {
		$http.put('/CodeCollegeSpringToolSuit_1_webstore/rest/cart/remove/' + productId).success(function(data) {
			$scope.refreshCart($scope.cartId);
		});
	};
